                ...
                <section className="flex flex-row  gap-50 ">
                        <div className='flex flex-col '>
                            <div className='flex gap-3 mt-30'>
                                ...
                                <p className="text-2xl text-white ">1000 Images per Day</p>
                            </div>
                            ...
                            <div className='flex gap-3 mt-30'>
                                ...
                                <p className="text-2xl text-white">1000 AI chats</p>
                            </div>
                            ...
                            <div className='flex gap-3 mt-30'>
                                ...
                                <p className="text-2xl text-white ">Bulk export</p>
                            </div>
                            ...
                            <div className='flex gap-3 mt-30'>
                                ...
                                <p className="text-2xl text-white ">Data retention 24 months</p>
                            </div>
                        ...
                        <div className='flex flex-col '>
                                ...
                                <h1 className='text-[#33CE95] font-semibold text-5xl '>Pro Version</h1>
